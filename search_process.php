...
$result = mysqli_query($conn, "SELECT * FROM list WHERE title LIKE '%$search%' OR content LIKE '%$search%' ORDER BY num DESC");
...
<html lang="ko">
    ...
    <body>
        <div class="container">
            ...
            <div class="item">
                <form>
                    <input name="search" type="text" class="search" placeholder="<?php echo $search ?>"></input> 
                </form>
                <ul>
                    <?php  
                    //인기글 10개 
